...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="discount-group | discount">
@endsection()
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="align-justify-center">
                    <a href="#" class="btn btn-default btn-sm flex-right modal-control" atr="Create">Giảm giá<i class="fas fa-plus m-l-5"></i></a> 
                </div>
            </div>
        </div>
        <div class="m-t-25">
